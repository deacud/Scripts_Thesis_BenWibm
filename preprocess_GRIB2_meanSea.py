...
Script to read in GRIB files and preprocess data on mean sea level and save it as netcdf file.
"""
...
var_dict_meanSea = {'dict_type': 'mean sea levels',
                    'typeOfLevel': 'meanSea',
...
def _preprocess_meanSea_known(dir_path, run, var, var_dict=var_dict_meanSea, extent=None, save=False):
    '''
...
def _preprocess_meanSea_unknown(dir_path, run, var, var_dict=var_dict_meanSea, extent=None, save=False):
    '''
...
def preprocess_GRIB2_meanSea_main(run=None, dir_path=None, var_list=None,
...
if __name__ == '__main__':
    ...
    HELP = """preprocess_GRIB2_meanSea: Preprocessing and combination of AROME GRIB2 output files.

    Usage:
       -h                      : print the help
       -r                      : modelrun to preprocess ('OP500, OP1000, OP2500, ARP1000, IFS1000')
                                  (default: 'OP500')
       -p,                     : parameters to preprocess (e.g. 'prmsl')
    ...
    if '-h' in args:
        ...
        if tmp_start == 'y':
            preprocess_GRIB2_meanSea_main(run=run, dir_path=dir_path, var_list=var_list,
